...
FROM
    TFirstMember as f
INNER JOIN TMembers as m
    ON f.id = m.id;

SELECT f.id FROM TFirstMember as f LEFT OUTER JOIN TMembers as m ON f.id = m.id;
SELECT f.id FROM TMembers as m LEFT OUTER JOIN TFirstMember as f ON f.id = m.id;


insert into TFirstMember (id) values(2);
SELECT * FROM TFirstMember as f LEFT OUTER JOIN TMembers as m ON f.id = m.id;
